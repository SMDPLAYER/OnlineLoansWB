package com.zavedapok.ysedo.utils
...
import com.zavedapok.ysedo.data.Profile
import java.util.*
...
//            arrayAdapter.add("Dream Girls")
    ...
    arrayAdapter.add("Erotic content")
    arrayAdapter.add("Dangerous acts")
    arrayAdapter.add("Minor user")
    arrayAdapter.add("Copyright infringement")
    arrayAdapter.add("Fraud")
    arrayAdapter.add("Calls for illegal activity")
    arrayAdapter.add("Other complaints")
